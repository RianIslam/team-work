    ...
    <div className="container-fluid">
      <div className="row pb-5">
        <div className="col-md-4">
          <div  data-aos="fade-up" className="ps-4">
            <h3>{car.title}</h3>
            <p>{car.details}</p>
          </div>

          <div data-aos="fade-up" className="ps-5 pe-5">
  ...
  return (
    <div>
      <div className="carDetailes">
        <h1 data-aos="fade-up" className="text-white d-flex justify-content-center text-center p-5">
        AVENTADOR
        ...
        <div className="row">
          ...
          <div className="col-md-10 padding">
            <div data-aos="fade-down" className=" d-flex justify-content-center text-center p-5 ">
              <div className=" ps-4">
      ...
      <div className="row">
        ...
        <div className="col-md-8">
          <div className="col-md-4 Experience">
            <div>
              <h2 data-aos="fade-up" className="text-white">Experience Model</h2>
            </div>
            <div data-aos="fade-up" className="p-4 d-flex justify-content-between">
